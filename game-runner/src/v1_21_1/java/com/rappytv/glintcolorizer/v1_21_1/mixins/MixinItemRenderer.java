package com.rappytv.glintcolorizer.v1_21_1.mixins;
...
import com.rappytv.glintcolorizer.v1_21_1.ColoredVertexConsumer;
import com.rappytv.glintcolorizer.v1_21_1.CustomRenderTypes;
...
public class MixinItemRenderer {
  ...
  private VertexConsumer modifyFoilBufferDirect(
    ...
    if (effect == ItemEffect.GLOW) {
      ...
      glintType = isItem ? RenderType.glintTranslucent() : RenderType.entityGlintDirect();
    }
